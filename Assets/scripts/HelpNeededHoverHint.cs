...
/// <summary>
/// Hover hint for a help-needed UI icon.
/// Attach this to the UI icon (Image/Button/RectTransform).
/// When hovered, it shows: "Help Needed"
/// Uses the existing HoverHintSystem + HoverHintUI.
/// </summary>
[DisallowMultipleComponent]
public class HelpNeededHoverHint : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    [Header("Hint")]
    ...
    [TextArea(1, 3)]
    public string message = "Help Needed";
