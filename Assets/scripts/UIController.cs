...
public class UIController : MonoBehaviour
{
    ...
    void Start()
    {
        //Vector2 screenPoint = WorldToCanvasPosition(canvas, cam, objectToFollow.position);

        //Vector3 pos = buttonA.transform.position;
        //buttonA.transform.position = screenPoint;
    }
    ...
    {
        //mini.gameObject.transform.localScale += new Vector3(3, 3, 3);
    }
}
