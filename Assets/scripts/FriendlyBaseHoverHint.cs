...
/// <summary>
/// Hover hint for a friendly base icon.
/// Attach this to the friendly base UI icon (Image/Button/RectTransform).
/// When hovered, it shows: "Ally Base"
/// Uses the existing HoverHintSystem + HoverHintUI.
/// </summary>
[DisallowMultipleComponent]
public class FriendlyBaseHoverHint : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    [Header("Hint")]
    ...
    [TextArea(1, 3)]
    public string message = "Ally Base";
